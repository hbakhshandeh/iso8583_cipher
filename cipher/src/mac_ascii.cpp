...
ascii_mac::ascii_mac(const std::string &mac_key) :
		mac(mac_key) {
}
...
std::optional<std::string> ascii_mac::generate(std::string_view msg) {
	if (msg.empty()) {
...
bool ascii_mac::verify(std::string_view msg, std::string_view msg_mac) {
